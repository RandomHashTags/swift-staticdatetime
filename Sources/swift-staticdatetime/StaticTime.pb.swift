...
public struct StaticTime: Sendable {
...
extension StaticTime: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "StaticTime"
  ...
  public static func ==(lhs: StaticTime, rhs: StaticTime) -> Bool {
